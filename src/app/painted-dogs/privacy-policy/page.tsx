...
<div class="container">
    ...
    <div class="section">
        <h2>Introduction</h2>
        <p>Thank you for choosing to use our collective action app. This Privacy Policy explains our practices
            regarding the limited data collection associated with Painted Dogs. We are
            committed to privacy by design and collect minimal information.</p>
    </div>

    <div class="section">
        <h2>Information We Collect</h2>
        <p>Painted Dogs is designed to collect as little information as possible. We do not collect, store, or process:</p>
        <ul>
            <li>Location data</li>
    ...
    <div class="section">
        ...
        <p>Painted Dogs is appropriate for all working people, including children
    ...
    <div class="section">
        <h2>Data Security</h2>
        <p>Since Painted Dogs collects minimal data, there is very
    ...
    <div class="section">
        ...
        <p>Pointyware LLC<br>
            <a href="mailto:privacy@pointyware.org">privacy@pointyware.org</a>
        </p></div>
    <div class="section">
        <h2>Consent</h2>
